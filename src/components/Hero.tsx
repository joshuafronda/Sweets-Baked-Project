      ...
      <div className="container px-4 sm:px-6 lg:px-8 z-10">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 text-center md:text-left mb-8 md:mb-0">
            ...
            <div className="flex flex-col sm:flex-row space-y-5 sm:space-y-0 sm:space-x-2 justify-center md:justify-start">
              <a 
                href="#gallery" 
              ...
              <a 
                ...
                className="bg-white hover:bg-pink-50 text-pink-500 font-medium mt-6 py-3 px-6 rounded-full shadow-md hover:shadow-lg border border-pink-200 transform hover:-translate-y-0.5 transition-all duration-200"
              >
                Order Now
              </a>
            </div>
